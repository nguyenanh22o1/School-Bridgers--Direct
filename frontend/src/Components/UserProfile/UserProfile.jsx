...
import SideBarLeft from "../Feed/YourFollowingRight/SideBarRight";
import SideBarRight from "../Feed/YourFollowingRight/SideBarLeft";
    ...
    <section className="userprofile-container">
      ...
      {isEdit ? (
        ...
        <>
          ...
          {currentUser?.isSchoolAdmin ? <div
            className="follow-container"
            style={{ boxShadow: `0px 0px 10px 3px ${currentUser?.theme}` }}
          >
            <div
              className="follower"
              style={{ borderRight: `1px solid #cdd1ce`, height: `65px`, marginLeft: `auto`, marginRight: `auto` }}
            >
