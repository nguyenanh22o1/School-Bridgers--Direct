...
const Popup = (props) => {
  ...
  const handleDelete = () => {
    ...
    console.log(user?.accessToken + " " + user.user?._id + " " + deletedPostId);
    deletePost(dispatch, user?.accessToken, isDelete.id, user.user?._id, setDelete, setDeletedPostId, deletedPostId);
